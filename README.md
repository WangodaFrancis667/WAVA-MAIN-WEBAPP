...
$ 
$ # install a Python 3.11.x version (example)
$ pyenv install 3.11.14
$ 
$ # create a virtualenv managed by pyenv (optional)
$ pyenv virtualenv 3.11.14 wava-py311
$ /Users/wangodafrancis/.pyenv/versions/3.11.14/bin/python -m venv venv
$ cd /Users/wangodafrancis/Desktop/WAVA-WATER-DISTRIBUTION
$ pyenv local 3.11.14   # sets .python-version in the repo folder
$ # Create tables
